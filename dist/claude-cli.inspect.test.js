...
import { classifyClaudeError, extractClaudeErrorFromMessages, extractClaudeErrorFromResult, parseAuthStatus, parseClaudeJsonOutput, } from "./claude-cli.inspect.js";
test("parseAuthStatus parses valid auth JSON", () => {
    assert.deepEqual(parseAuthStatus('{"loggedIn":true,"authMethod":"oauth_token","apiProvider":"firstParty"}'), {
        loggedIn: true,
...
//# sourceMappingURL=claude-cli.inspect.test.js.map